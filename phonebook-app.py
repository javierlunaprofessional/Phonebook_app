...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', persons_html=persons_app, keyword=keyword, show_result=True, developer_name='Javier')
    else:
        return render_template('index.html', show_result=False, developer_name='Javier')
